...
-- Self-contained procedural generator and ring-buffer manager.
-- ========================================================================
...
return function(
    ...
    -- ==========================================
    -- PHASE 1: THE BIG BANG (Closure Setup)
    -- ==========================================
    ...
    for slot = 0, MAX_TILES - 1 do
        ...
        for i = 1, #indices, 3 do
            ...
            -- Use BakedColor to mesh with your static rasterizer!
            Tri_BakedColor[tIdx] = (slot % 2 == 0) and 0xFF222222 or 0xFF444444
        end
        
        -- Hide the tiles deep underground initially
    ...
    -- ==========================================
    -- PHASE 2: THE HOT LOOP
    -- ==========================================
    return function(dt)
        -- HARD GATING: Only run if we are in OVERVIEW, or if we are flying TO Overview!
