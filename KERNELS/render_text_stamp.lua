...
return function(SlideCaches, ActiveSlide, EngineState, Slide_X, Slide_Y, Slide_Z, Slide_NX, Slide_NY, Slide_NZ, MainCamera, ScreenPtr, ZBuffer)
    return function(CANVAS_W, CANVAS_H, HALF_W, HALF_H, MasterAlpha)
        ...
        local sx, sy, sz = Slide_X[slide_idx], Slide_Y[slide_idx], Slide_Z[slide_idx]
        local bnx, bny, bnz = Slide_NX[slide_idx], Slide_NY[slide_idx], Slide_NZ[slide_idx]
